...
for file in "$@"; do
    ...
    while IFS= read -r result; do
        ...
        # pct is always the absolute value of the percentage change; kind distinguishes
        # regressions (R) from improvements (I) so negative-change parsing stays unambiguous.
